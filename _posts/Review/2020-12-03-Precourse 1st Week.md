...
11월 초, 우테코 3기를 모집한다는 글을 보았습니다. 국내 개발회사들 중 가장 유명하다고 할 수 있는 **우아한 형제**에서 진행하는 교육 과정이기에 설레임을 안고 신청하게 되었습니다. 처음 있는 코딩테스트는
...
```
위의 코드와 같이 모든 생성자에 대해서 혹시 모를 예외를 위해 try-catch 문을 적용해주야 할 것입니다. 이는 예외가 발생하는 
